...
<section>
    ...
    style="background-image: url('images/Banner-Catalog/FONDO-CATALOGO-BANNER.png');" >
        ...
        <div class=" xl:h-93 xl:w-140 xl:mt-20 xl:order-1   lg:h-80 lg:w-120 lg:mt-25 lg:order-1    md:h-60 md:w-90 md:mt-20 md:order-1    sm:h-46 sm:w-75 sm:mt-15 sm:ml-1 sm:order-1   h-30 w-50 mb-12 mt-5   order-2">
            <img src="images/Banner-Catalog/MOTOCICLETAS.png" alt="Motocicleta " class="select-none">
        </div>
         ...
         <div class=" xl:h-43 xl:w-130 xl:mb-10 xl:ml-10 xl:order-2   lg:h-37 lg:w-105 lg:mb-6 lg:ml-10 lg:order-2   md:h-30 md:w-80 md:mb-5 md:ml-6 md:order-2   sm:h-17 sm:w-65 sm:mb-11 sm:ml-3 sm:order-2   h-17 w-65 mt-10 ml-0 order-1 ">
            ...
            <img src="images/Banner-Catalog/Texto.png" alt="Texto" class="select-none">
            ...
            <img src="images/Banner-Catalog/LOGOS.png" alt="Logos" class="select-none">
            </div>
         </div>
   ...
   <div class="flex flex-row justify-center w-full pl-30 pr-30 sm:pl-60 sm:pr-60 md:pl-70 md:pr-70 pt-10 lg:hidden p-4 select-none">
    <button
...
<section>
    <div class="flex flex-row w-full justify-center pl-4 sm:pl-16 md:pl-34 lg:pr-0 lg:pl-10 xl:pl-42  mt-5 mb-5 select-none">
        <p
